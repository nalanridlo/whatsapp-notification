    ...
    <div class="bg-white rounded-[20px] shadow-lg p-8 w-[400px] space-y-6 p-[20px]">
        ...
        <form method="POST" action="{{ route('users.storeUsers') }}" >
            ...
            <div class="mb-4">
                ...
                <input type="text" required id="nama" name="nama" placeholder="Nama" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <!-- Form Birthdate -->
            <div class="mb-4">
                <label for="tanggalLahir" class="block text-sm font-medium text-gray-700">Tanggal Lahir</label>
                <input type="date" required name="tanggalLahir" id="tanggalLahir" placeholder="Tanggal Lahir" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <!-- Form Number -->
            <div class="mb-4">
                <label for="phone_number" class="block text-sm font-medium text-gray-700">Nomor WhatsApp</label>
                <input type="text" required name="phone_number" id="phone_number" placeholder="Nomor WhatsApp" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <!-- Form Expired Date -->
            <div class="mb-4">
                <label for="expire_date" class="block text-sm font-medium text-gray-700">Tanggal Berakhir</label>
                <input type="date" required name="expire_date" id="expire_date" placeholder="Tanggal Berakhir" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <!-- Submit Button -->
