<div id="alert-deletion" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex justify-center items-center">
    <div class="bg-[#02182B] w-[410px] p-[20px] rounded-[20px] flex flex-col items-center space-y-4">
        <div class="text-center">
            <h2 class="text-[20px] font-semibold text-white mx-[10px]">Apakah Anda Yakin?</h2>
            <p class="text-[14px] text-[#F7F7F7] mb-[20px]">Apakah anda yakin ingin menhapus data ini?</h4>
        </div>
